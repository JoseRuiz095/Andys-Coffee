        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-6 py-3 text-right font-semibold text-gray-900">Stock Mínimo</th>
              <th className="px-6 py-3 text-right font-semibold text-gray-900">Costo Unitario</th>
              <th className="px-6 py-3 text-right font-semibold text-gray-900">Valor</th>
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right text-gray-600">
                    ...
                    <span className="text-gray-500">{ingredient.unit.abbreviation}</span>
                  </td>
                  <td className="px-6 py-4 text-right text-gray-600">
